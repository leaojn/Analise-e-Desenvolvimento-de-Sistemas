...
#     User.objects.create(name=nome, phone=phone, email=email, city=city,
#                         street=street, suite=suite, zipcode=zipcode)
# for i in json['posts']:
#     title = i['title']
#     body = i['body']
#     userid = i['userId']
#     Post.objects.create(title=title, body=body, user_id=userid)
